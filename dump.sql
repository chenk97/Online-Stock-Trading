...
CREATE TABLE `ConditionalOrderHistory` (
  `CondOrderId` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `HiddenStop` (
  ...
  `OrderId` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`StopId`),
  KEY `HiddenStop_Orders__fk` (`OrderId`),
  CONSTRAINT `HiddenStop_Orders__fk` FOREIGN KEY (`OrderId`) REFERENCES `Orders` (`OrderId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `HiddenStop` (`StopId`, `StopPrice`, `OrderId`) VALUES (1,10,4);
...
INSERT INTO `Portfolio` (`PortfolioId`, `AccountId`, `StockSymbol`, `NumShares`) VALUES (1,1,'BMI',100),(2,1,'GM',100),(3,1,'BMI',50),(4,1,'GM',20),(5,1,'BMI',-30),(6,1,'BMI',-20),(7,1,'GM',-20);
...
INSERT INTO `Stock` (`StockSymbol`, `CompanyName`, `Type`, `PricePerShare`, `NumShares`) VALUES ('BMI','BMI Foundation','Computer',34.00,999999880),('GM','GM Company','Automobile',10.00,999999880);
...
INSERT INTO `StockPriceHistory` (`HisId`, `StockSymbol`, `PricePerShare`, `DateNTime`) VALUES (1,'BMI',20.00,'2019-05-08 02:31:49'),(2,'GM',12.00,'2019-05-08 02:31:49'),(3,'BMI',30.00,'2019-05-08 02:46:35'),(4,'BMI',35.00,'2019-05-08 02:47:26'),(5,'BMI',40.00,'2019-05-08 02:47:42'),(6,'BMI',34.00,'2019-05-08 02:49:47'),(7,'GM',10.00,'2019-05-08 02:50:43');
...
INSERT INTO `Transaction` (`TransactionId`, `TransFee`, `DateNTime`, `PricePerShare`) VALUES (1,100.00,'2019-05-08 02:41:00',20.00),(2,60.00,'2019-05-08 02:41:07',12.00),(3,50.00,'2019-05-08 02:43:58',20.00),(4,12.00,'2019-05-08 02:44:15',12.00),(5,30.00,'2019-05-08 02:44:52',20.00),(6,34.00,'2019-05-08 02:49:47',34.00),(7,10.00,'2019-05-08 02:50:43',10.00);
